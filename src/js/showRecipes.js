...
const recipesList = document.querySelector("#list-recipes"); // <section id="list-recipes"></section>
...
//   "#card-recipe__list-ingredients"
// );

// ingredientsList.innerHTML = recipes
//   .map((recipe) => {
//     const recipesIngredients = recipe.ingredients;

//     return recipesIngredients.map(recipeIngredientsListTemplate).join("");
//   })
//   .join("");
